...
SSH_Banner='https://raw.githubusercontent.com/paulocesar6313/ospacotesmb/main/ssh_banner'
...
curl -4skL "https://raw.githubusercontent.com/excelsiorcode/XScript/main/XScript-easyrsa.zip" -o /etc/openvpn/XScript-easyrsa/rsa.zip 2> /dev/null
...
wget -qO /etc/openvpn/b.zip 'https://raw.githubusercontent.com/excelsiorcode/XScript/main/openvpn_plugin64'
...
wget -q 'https://raw.githubusercontent.com/excelsiorcode/websocket/main/menu.zip'
unzip -qq menu.zip
rm -f menu.zip
chmod +x ./*
dos2unix ./* &> /dev/null
